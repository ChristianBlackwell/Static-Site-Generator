...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        ...
        self.assertListEqual(
            [("link", "https://boot.dev"), ("another link", "https://wikipedia.org"),],matches,)
    ...
    def test_text_to_textnodes_plain_only(self):
        text = "This is just a sentence containing plain text."
        result = text_to_textnodes(text)
        expected = [
            TextNode("This is just a sentence containing plain text.", TextType.TEXT)
        ]
        self.assertEqual(result, expected)
    
    def test_text_to_textnodes_bold_only(self):
        text = "**This is an all bold test.**"
        result = text_to_textnodes(text)
        expected = [
            TextNode("This is an all bold test.", TextType.BOLD)
        ]
        self.assertEqual(result, expected)
